...
If `guard` fails, the framework disables the mod. Key generation, credential generation, and `.zip` to `.modpack` conversion are available in [maplebirch-author-tools](https://github.com/MaplebirchLeaf/maplebirch-author-tools).

...
declare class LanguageManager {
	...
	importAll(modName: string, langs?: readonly string[]): AsyncGenerator<{
		lang: string;
		type: string;
		progress: number;
		current: number;
...
declare class ToolCollection {
	...
	addTo(zone: string, ...widgets: (string | Function | ZoneWidgetConfig | [
		number,
		string | ZoneWidgetConfig
	])[]): void;
	preInit(): void;
}
declare class Track {
...
declare const NPCSchedules: typeof Schedule & {
	...
	add: (npcName: string, scheduleConfig: ScheduleTime | ScheduleCondition, location: string | ScheduleLocation, id?: string | number, options?: Partial<Omit<SpecialSchedule, "condition" | "location">>) => Schedule;
...
declare function clone$1(source: any, opt?: {
	deep?: boolean;
	proto?: boolean;
}, map?: WeakMap<object, any>): any;
declare function contains$1(arr: any[], value: any | any[], mode?: "all" | "any" | "none", opt?: {
	case?: boolean;
	compare?: Function;
	deep?: boolean;
}): boolean;
declare function convert$1(str: string, mode?: "lower" | "upper" | "capitalize" | "title" | "camel" | "pascal" | "snake" | "kebab" | "constant", opt?: {
	delimiter?: string;
	acronym?: boolean;
}): string;
...
declare function random$1(min?: number | {
	min: number;
	max: number;
	float?: boolean;
...
export type InitFunction = Function | {
	init: Function;
} | {
	name: string;
	func: Function;
...
declare namespace utils {
	export { SelectCase$1 as SelectCase, clone$1 as clone, contains$1 as contains, convert$1 as convert, either$1 as either, equal$1 as equal, loadImage$1 as loadImage, merge$1 as merge, random$1 as random };
}

...
const upper_layers = {
  ...
  nnpc_upper_main: clothes_layer('upper', 'main', {
    masksrcfn(options: LayerOptions) { return options.maplebirch.nnpc.upper_mask; },
  ...
  nnpc_upper_acc: clothes_layer('upper', 'acc', {
    masksrcfn(options: LayerOptions) { return options.maplebirch.nnpc.upper_mask; },
    zfn(options: LayerOptions) { return options.maplebirch.nnpc.zupper!; }
  }),
  ...
  nnpc_upper_leftarm: clothes_arm('upper', 'left', {
    zfn(options: LayerOptions) { return options.maplebirch.nnpc.zupperleft!; },
  }),
  nnpc_upper_rightarm: clothes_arm('upper', 'right', {
    zfn(options: LayerOptions) { return options.maplebirch.nnpc.zupperright!; },
  }),
  ...
  nnpc_under_upper_breasts_detail: clothes_breasts('under_upper', 'detail', {
    zfn(options: LayerOptions) { return maplebirch.char.ZIndices.under_upper + options.maplebirch.nnpc.position!; },
  }),
